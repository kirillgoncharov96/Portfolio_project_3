...
/*#__PURE__*/
function (_Requests) {
  _inherits(Form, _Requests);

  function Form(form, inputs) {
    _classCallCheck(this, Form);

    return _possibleConstructorReturn(this, _getPrototypeOf(Form).call(this, form, inputs));
  }
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      ...
      var cityInputs = document.querySelector('#city');
  ...
  return Form;
}(_services_requests__WEBPACK_IMPORTED_MODULE_13__["default"]);
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        ...
        if (_this2.player && typeof _this2.player.stopVideo === 'function') {
...
function (_Slider) {
  ...
  function MainSlider(container, btns, prevBtns, nextBtns) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, btns, prevBtns, nextBtns));
  }
